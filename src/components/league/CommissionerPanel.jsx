...
export default function CommissionerPanel({ commissioner, leagueId, tournamentId, windowType = null, memberCount = 0, leagueName = 'LEAGUE', league = null }) {
  ...
  if (isMobile) {
    ...
    return (
      <div style={{ flex: 1, overflow: 'auto', background: 'var(--ink)', display: 'flex', flexDirection: 'column' }}>
        ...
        {/* Bet management (mobile) */}
        <MobSectionHeader label="BET MANAGEMENT" sub="CREATE · RESOLVE · HISTORY" tone="var(--cyan)" />
        <div style={{ padding: '0 14px' }}>
          <BetCreatorPanel
            ...
            onCreated={() => { fetchOpenBets(); fetchAllBets(); }}
          />
        </div>
        <ResolvePendingBets
          openBets={openBets}
  ...
  return (
    <div style={{ flex: 1, overflow: 'auto', background: 'var(--ink)', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Zone C — Bet creation */}
      <HubSectionLabel label="CREATE BET" sub="FOOTBALL PREDICTION WIDGET" tone="var(--cyan)" />
