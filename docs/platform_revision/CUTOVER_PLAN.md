...
| 6 | Phase 3B smoke passes: platform.spec ✅ (262/262 on 2026-07-17) · football · P2P (`MOCK_PAYMENTS=true`) · F1 · tennis | ✅ football/P2P/F1 done (P2P's two-manager Challenge-accept path still unexercised — needs a second manager in the same football league). ⬜ **tennis** — test plan corrected and written up ([PR #769](https://github.com/SMTCB/WCFantasyFootball/pull/769), `docs/testing/TENNIS_MODULE_TEST_PLAN.md`), individual scenarios (Modules 1–6) not yet run against live data. |
