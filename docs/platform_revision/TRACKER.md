...
- **DD items** — DATA-2 (GDPR delete_user_data RPC, migration 219_), DATA-3 (data classification doc), P2P-LOAD (load test script)
...
Last Updated: **2026-07-01** (CODE-3 done — PR #695. Sentry captureException wired into ErrorBoundary; AppShell boundary added around AppLayout; Kit Light token fixes. Also: DD items A2+BUILD-1+C3+B2 done — PR #694. Next migration: 219_. Next: OPS-2 (Sentry Edge Functions), DATA-2/3, or Phase 3B smoke tests.)
