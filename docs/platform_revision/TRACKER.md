...
- **DD items** — P2P-LOAD (load test script). OPS-2 part (c) is now code-complete (PR #724) — remaining OPS-2 work is all approval-gated deploys, see below.
- **Approval-gated deploys** — rows 19–20, 22–26 (GDPR RPC + LEGAL-1 constraint + OPS-2 function deploys), requires Supabase-linked PC
