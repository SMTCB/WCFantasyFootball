...
**Still open**: P1 items B1–B4 from the same audit remain deprioritized/paused per the user's earlier direction — not abandoned, can resume on request.
