...
**Open gaps** (see BI-01, BI-02 in P2 below): RecapView doesn't yet use `squad_matchday_snapshots` as primary source; no automated backup cron. BI-03 (squad event log) is now ✅ done (migration 183, PR #589).
