...
## ✅ F1 race-result sync automated via cron — replaces manual OpenF1 fetch (2026-09-01) — PR #903, migration 276 (not yet applied)
...
**Not yet done (needs per-item approval, per CLAUDE.md)**: migration 276 has not been applied to the live DB, and `sync-f1-race-results` has not been deployed. The manual P1/P2/P3 dropdowns on `F1AdminScreen` remain the only working path until both land.
