...
**Next in this plan**: PR 1.5 "Open Challenges", PR 3 (win-streak badge), and PR 4 (chat quick-bet + live bet feed) each need a migration and their own fresh per-item approval before any SQL is written — none sought yet.
