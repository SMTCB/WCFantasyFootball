...
**Open gaps** (see BI-02 in P2 below): no automated backup cron. BI-01 closed (do not implement — see P2 table). BI-03 (squad event log) is now ✅ done (migration 183, PR #589).
