...
**Next in this plan**: PR 3 (win-streak badge) and PR 4 (chat quick-bet + live bet feed) each still need a migration and their own fresh per-item approval before any SQL is written — none sought yet.
...
**Next in this plan**: PR 1.5 "Open Challenges" shipped (see PR #891, above). PR 3 (win-streak badge) and PR 4 (chat quick-bet + live bet feed) each still need a migration and their own fresh per-item approval before any SQL is written — none sought yet.
...
**Next in this plan** (see full detail in the plan file / "Last Updated" banner above): PR 1.5 "Open Challenges" and PR 3 (win-streak badge) and PR 4 (chat quick-bet + live bet feed) each need a migration and their own fresh per-item approval before any SQL is written — none sought yet. PR 2 (bet templates, smart default targeting, one-tap rematch) needs no migration and is next up.
