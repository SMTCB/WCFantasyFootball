...
| **L-5** | 🔒 Remove test/dry-run data from the pilot DB | `DD-P1-1` | Cheap, and it is what a tester would otherwise browse into ("Smoke Test League", the stuck tennis tournament, 4 empty circles). Pilot Safeguard #4. |
