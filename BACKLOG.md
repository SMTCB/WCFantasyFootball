...
**E2E Test Suite**: full `e2e/` suite passing ✅ — 262 passed / 33 conditionally-skipped, 2026-07-17; `platform.spec.js` (36 tests × 2 browsers) passing in CI ✅, including the previously-flaky `SquadScreen › shows budget in header` test — fixed 2026-07-30, see resolved `B-11`
