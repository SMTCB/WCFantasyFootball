-- ✅ APPLIED TO PRODUCTION 2026-07-12 (main session, as migration 196 — renumbered 196→222 on v2 2026-07-17; do NOT re-apply)
-- Migration 222 (renumbered from 196): raise the classic-mode free transfer allowance from 5→6.
--
